...
PARAM_CLASSDEFINE(PARAM_VODEV_S,VOCFG,CTX,VO)[] = {
    {
        .stVoConfig = {
            ...
            .stVoPubAttr.enIntfSync  = VO_OUTPUT_480x640_60,
        ...
        .u8ChnRotation = ROTATION_270,
    }
};

PARAM_VO_CFG_S g_stVoCtx = {
#if (CONFIG_PANEL_HX8394 == 1 || CONFIG_PANEL_ILI9488 == 1 || CONFIG_PANEL_OTA7290B == 1 || CONFIG_PANEL_BJX2836F0 == 1)
    .u8VoCnt = 1,
#else
    .u8VoCnt = 0,
#endif
